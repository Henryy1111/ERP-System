...
import { supabase } from "../../../lib/supabase"; // Pastikan alias @ atau sesuaikan path-nya
...
export default function SuppliersManagementPage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      {/* HEADER SECTION - Identik dengan Categories */}
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight flex items-center gap-3">
              Network <span className="text-blue-600 italic">Suppliers</span>{" "}
              <Truck className="text-slate-300" />
            </h1>
            <p className="text-slate-500 font-medium">
              Manajemen rantai pasokan dan integrasi mitra bisnis.
            </p>
          </div>
      ...
      {/* SUPPLIERS TABLE CARD - Identik dengan Categories */}
                ...
                >
                  ...
                  <td className="px-8 py-6">
                    <div>
                      ...
                      <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest flex items-center gap-1 mt-1">
                  ...
                  <td className="px-8 py-6">
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2 text-slate-500 text-[11px] font-medium italic">
                  ...
                  <td className="px-8 py-6">
                    {item.is_active ? (
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-full w-fit text-[10px] font-black uppercase tracking-tighter">
                        <CheckCircle2 className="w-3 h-3" /> Active
                      </div>
                    ) : (
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-red-50 text-red-600 border border-red-100 rounded-full w-fit text-[10px] font-black uppercase tracking-tighter">
                  ...
                  <td className="px-8 py-6 text-center">
                    <div className="flex justify-center items-center gap-3">
                      <Link
                        href={`/dashboard/admin/suppliers/edit/${item.id}`}
      ...
      {/* CUSTOM DELETE MODAL - Identik dengan Categories */}
      {isDeleteModalOpen && (
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-500 font-medium leading-relaxed px-4">
                  ...
                  akan memutus akses data terkait di sistem.
                </p>
              </div>
